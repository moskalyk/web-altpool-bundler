...
var single_module_srv_1 = require("./_aqua/single-module-srv");
var Buffer_1 = __importDefault(require("./Buffer"));
var browser_or_node_1 = require("browser-or-node");
var avm_1 = require("@fluencelabs/avm");
var SingleModuleSrv_1 = require("./builtins/SingleModuleSrv");
var node_utils_1 = require("./_aqua/node-utils");
                ...
                switch (_f.label) {
                    ...
                    case 6:
                        ...
                        this._classServices = {
                            ...
                            srv: new SingleModuleSrv_1.Srv(this),
                        };
                        ...
                        (0, single_module_srv_1.registerSrv)(this, this._classServices.srv);
                        (0, node_utils_1.registerNodeUtils)(this, new SingleModuleSrv_1.NodeUtils(this));
            ...
            if (item.result.callRequests.length > 0) {
                var _loop_1 = function (key, cr) {
                    ...
                    _this._execSingleCallRequest(req)
                        .catch(function (err) {
                        if (err instanceof utils_1.ServiceError) {
                            return {
